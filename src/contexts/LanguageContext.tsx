...
const translations = {
  ar: {
    ...
    "contactPage.addressLine1": "شبين الكوم، شارع استاد الجامعة، خلف المستشفى العسكري",
    "contactPage.addressLine2": "للمعهد مدخل خاص بجوار مركز الخدمة العامة بجامعة المنوفية",
    "contactPage.phoneLabel": "الهاتف",
    "contactPage.phoneNumber": "02 35355628",
    "contactPage.emailLabel": "البريد الإلكتروني",
    "contactPage.emailAddress": "itiinfo@iti.gov.eg",
    "contactPage.workHours": "ساعات العمل",
    "contactPage.workDays": "الأحد - الخميس: 08:30 ص - 03:30 م",
  ...
  en: {
    ...
    "contactPage.addressLine1": "Shebin El Kom, University Stadium Street, behind the Military Hospital",
    "contactPage.addressLine2": "The institute has a private entrance next to the Public Service Center of Menoufia University",
    "contactPage.phoneLabel": "Phone",
    "contactPage.phoneNumber": "02 35355628",
    "contactPage.emailLabel": "Email",
    "contactPage.emailAddress": "itiinfo@iti.gov.eg",
    "contactPage.workHours": "Working Hours",
    "contactPage.workDays": "Sunday - Thursday: 08:30 AM - 03:30 PM",
