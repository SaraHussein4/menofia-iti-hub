...
const translations = {
  ar: {
    ...
    "aboutPage.sectionTitle": "نبذة عن المعهد",
    "aboutPage.p1": "تأسس معهد تكنولوجيا المعلومات (ITI) عام 1993 كأحد المبادرات الرائدة لوزارة الاتصالات وتكنولوجيا المعلومات المصرية. يهدف المعهد إلى تأهيل وتدريب الكوادر البشرية المصرية في مجالات تكنولوجيا المعلومات المختلفة.",
    "aboutPage.p2": "فرع المنوفية هو أحد الفروع الإقليمية للمعهد، تم افتتاحه لخدمة شباب محافظة المنوفية والمحافظات المجاورة. يقدم الفرع نفس البرامج التدريبية عالية الجودة المقدمة في الفرع الرئيسي بالقاهرة.",
    "aboutPage.p3": "نفخر بأننا ساهمنا في تخريج آلاف المتدربين الذين يعملون الآن في كبرى الشركات المحلية والعالمية، مما يؤكد على جودة التدريب والتأهيل الذي نقدمه.",
  ...
  en: {
    ...
    "aboutPage.sectionTitle": "About the Institute",
    "aboutPage.p1": "The Information Technology Institute (ITI) was established in 1993 as one of the leading initiatives of the Egyptian Ministry of Communications and Information Technology. The institute aims to qualify and train Egyptian human resources in various information technology fields.",
    "aboutPage.p2": "The Menofia branch is one of the regional branches of the institute, opened to serve the youth of Menofia and neighboring governorates. The branch offers the same high-quality training programs offered at the main branch in Cairo.",
    "aboutPage.p3": "We are proud to have contributed to graduating thousands of trainees who now work in major local and international companies, confirming the quality of training and qualification we provide.",
